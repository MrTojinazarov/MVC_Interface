<div class="row mt-3">
    ...
    <div class="col-8 offset-2 mt-3">
        <form action="ShowupApi" method="POST" enctype="multipart/form-data">
            <div class="mb-3">
            ...
            <div class="col-2 offset-5">
                <button type="submit" name="ok" class="btn btn-outline-warning" style="width: 100px;">Show Api</button>
            </div>
        </form>
    </div>
</div>